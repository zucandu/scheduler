        ...
        <div class="container">
            ...
            <div v-else class="row">
                <div class="col-12 text-center">
                    <p>You have already logged into the system. Please go to the <router-link to="/store/dashboard">Zucandu Free Gifts Dashboard</router-link> or back to the <router-link to="/">home page</router-link>.</p>
                </div>
            </div>
        </div>

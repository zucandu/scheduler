<template>
    <div class="container">
            ...
            <div class="col-4 pt-1">
                <a class="btn btn-sm btn-link px-0 text-decoration-none" href="https://zucandu.com" target="_blank">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-in-up-right" viewBox="0 0 16 16">
                        ...
                        <path fill-rule="evenodd" d="M11 5.5a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h4.793l-8.147 8.146a.5.5 0 0 0 .708.708L10 6.707V10.5a.5.5 0 0 0 1 0v-5z"/>
                    </svg>
                </a>
            </div>
        ...
        <section class="mt-5">
            <h2 class="mb-4 text-uppercase">Privacy</h2>
            <div class="mb-5">
                <!-- Title -->
                <div class="mb-3">
            ...
            <div class="mb-5">
                <div class="mb-3">
                    <h3 class="h5 text-primary font-weight-semi-bold">Definitions</h3>
                </div>
                <ul>
                    <li>
            ...
            <div class="mb-5">
                <div class="mb-3">
                    <h3 class="h5 text-primary font-weight-semi-bold">Types of Data Collected</h3>
                </div>
                ...
                <p class="text-primary">Usage Data</p>

                <p>We may also collect information how the Service is accessed and used ("Usage Data"). This Usage Data may include information such as your computer's Internet Protocol address (e.g. IP address), browser type, browser version, the pages of our Service that you visit, the time and date of your visit, the time spent on those pages, unique device identifiers and other diagnostic data.</p>


                <p class="text-primary">Tracking &amp; Cookies Data</p>
            ...
            <div class="mb-5">
                ...
                <ul>
                    ...
                    <li><p>The processing is in our legitimate interests and it's not overridden by your rights</p></li>
                    <li><p>For payment processing purposes</p></li>
            ...
            <div class="mb-5">
                <div class="mb-3">
                    <h3 class="h5 text-primary font-weight-semi-bold">Transfer of Data</h3>
                </div>
            ...
            <div class="mb-5">
                <div class="mb-3">
                    <h3 class="h5 text-primary font-weight-semi-bold">Security of Data</h3>
                </div>
                <p>The security of your data is important to us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your Personal Data, we cannot guarantee its absolute security.</p>
            </div>
            <div class="mb-5">
                <div class="mb-3">
                    <h3 class="h5 text-primary font-weight-semi-bold">"Do Not Track" Signals Under California Online Privacy Protection Act (CalOPPA)</h3>
                </div>
            ...
            <div class="mb-5">
                ...
                <ul>
                    <li>
                        ...
                        <p>You can opt-out of Google Analytics for Display Advertising and customize the Google Display Network ads by visiting the Google Ads (AdWords) Settings page: <a href="http://www.google.com/settings/ads">http://www.google.com/settings/ads</a></p>
            ...
            <div class="mb-5">
                <div class="mb-3">
                    <h3 class="h5 text-primary font-weight-semi-bold">Links to Other Sites</h3>
                </div>
            ...
            <div class="mb-5">
                <div class="mb-3">
                    <h3 class="h5 text-primary font-weight-semi-bold">Childrens' Privacy</h3>
                </div>
            ...
            <div class="mb-5">
                <div class="mb-3">
                    <h3 class="h5 text-primary font-weight-semi-bold">Changes to This Privacy Policy</h3>
                </div>
            ...
            <div class="mb-5">
                <div class="mb-3">
                    <h3 class="h5 text-primary font-weight-semi-bold">Contact Us</h3>
                </div>
                <p>If you have any questions about this Privacy Policy, please contact us at support[at]adnabu.com or via the <a class="navy-link" href="/contact-us?hsLang=en">contact form</a>.</p>
            </div>
